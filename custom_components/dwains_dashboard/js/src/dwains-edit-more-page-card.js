...
Promise.race(waitForHelpers).then(async () => {
    ...
    async _save(data) {
      ...
      try {
        await this._hass.callWS({
          type: 'dwains_dashboard/more_page/set',
          ...data,
        });
  ...
  if (!customElements.get('dwains-edit-more-page-card')) {
    customElements.define('dwains-edit-more-page-card', LcarsEditMorePageCard);
  }
});

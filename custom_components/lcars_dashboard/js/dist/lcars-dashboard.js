...
`;class l extends r.WF{static get properties(){return{_hass:{type:Object},_config:{type:Object},_order:{type:Array},_columnOverrides:{type:Object},_selected:{type:String}}}set hass(e){this._hass=e}setConfig(e){this._config=e;const t=e?.panels||[];this._order=t.map(e=>e.panelId),this._columnOverrides={...e?.column_overrides||{}},this._selected=e?.panel_id||t[0]?.panelId||""}_getPanelInfo(e){return(this._config?.panels||[]).find(t=>t.panelId===e)}_isIllumination(e){const t=this._getPanelInfo(e);return t?.panelType===n.sv}_getColumn(e){if(this._isIllumination(e))return"full";const t=this._getPanelInfo(e);return this._columnOverrides[e]||this._columnOverrides[t?.panelType]||n.uC[t?.panelType]||"left"}_getLabel(e){const t=this._getPanelInfo(e);return t?t.label||t.panelType.replace(/_/g," "):e}_select(e){this._selected=e}_moveUp(){const e=this._getColumn(this._selected),t=this._order.filter(t=>this._getColumn(t)===e),a=t.indexOf(this._selected);if(a<=0)return;const r=this._order.indexOf(this._selected),i=this._order.indexOf(t[a-1]),s=[...this._order];[s[i],s[r]]=[s[r],s[i]],this._order=s}_moveDown(){const e=this._getColumn(this._selected),t=this._order.filter(t=>this._getColumn(t)===e),a=t.indexOf(this._selected);if(a<0||a>=t.length-1)return;const r=this._order.indexOf(this._selected),i=this._order.indexOf(t[a+1]),s=[...this._order];[s[r],s[i]]=[s[i],s[r]],this._order=s}_moveLeft(){this._isIllumination(this._selected)||"left"!==this._getColumn(this._selected)&&(this._columnOverrides={...this._columnOverrides,[this._selected]:"left"})}_moveRight(){this._isIllumination(this._selected)||"right"!==this._getColumn(this._selected)&&(this._columnOverrides={...this._columnOverrides,[this._selected]:"right"})}async _save(){if(this._hass&&this._config?.area_id)try{await this._hass.callWS({type:"lcars_dashboard/panel_order/set",area_id:this._config.area_id,panel_order:JSON.stringify(this._order)});const e={};for(const[t,a]of Object.entries(this._columnOverrides)){const r=this._getPanelInfo(t);a!==(n.uC[r?.panelType]||"left")&&(e[t]=a)}await this._hass.callWS({type:"lcars_dashboard/panel_column/set",area_id:this._config.area_id,panel_columns:JSON.stringify(e)}),(0,s.rC)("lcars_dashboard_reload")}catch(e){console.error("LCARS Edit: Panel layout save failed",e)}}async _reset(){if(this._hass&&this._config?.area_id)try{await this._hass.callWS({type:"lcars_dashboard/panel_order/set",area_id:this._config.area_id,panel_order:JSON.stringify([])}),await this._hass.callWS({type:"lcars_dashboard/panel_column/set",area_id:this._config.area_id,panel_columns:JSON.stringify({})});const e=this._config?.panels||[];this._order=e.map(e=>e.panelId),this._columnOverrides={},(0,s.rC)("lcars_dashboard_reload")}catch(e){console.error("LCARS Edit: Panel layout reset failed",e)}}static get styles(){return[i.Bx,o]}_renderPanelItem(e,t){const a=e===this._selected,i=this._isIllumination(e),s=this._getPanelInfo(e),n=s?.panelType?.replace(/_/g," ")||"",o=this._getLabel(e),l=s?.deviceId&&o.toLowerCase()!==n.toLowerCase();return r.qy`
    ...
    `}getCardSize(){return 5}}customElements.get("lcars-edit-panel-order-card")||customElements.define("lcars-edit-panel-order-card",l)},5316(e,t,a){var r=a(7349),i=a(8851),s=a(2622),n=a(7597),o=a(6930),l=a(4867),c=a(9411);a(6940),a(6564),new Set(["battery","power","energy","voltage","current"]);const d=/ups|battery_charge|battery_runtime|battery_voltage/i,p=/grid|mains|main.*panel|total|balance/i;class u extends r.WF{static get properties(){return{hass:{type:Object},_config:{type:Object},filter:{type:String}}}constructor(){super(),this._hass=null,this._config={},this.filter="all",this._entityCache=new Map,this._onFilter=e=>{this.filter=e.detail.filter}}connectedCallback(){super.connectedCallback(),i.o6.addEventListener("lcars-eng-filter",this._onFilter)}disconnectedCallback(){super.disconnectedCallback(),i.o6.removeEventListener("lcars-eng-filter",this._onFilter)}setConfig(e){this._config=e||{}}set hass(e){const t=this._hass;this._hass=e,e&&t!==e&&(this._entityCache.clear(),this.requestUpdate("hass",t))}get hass(){return this._hass}getCardSize(){return 16}_discoverAll(){if(!this._hass)return{batteries:[],circuits:[],gridSensors:[],upsSensors:[],totalDraw:0};const e=this._hass.states||{},t=[],a=[],r=[],i=[];let s=0;const c=(0,n.Qn)(this._hass),u=(0,n.E3)(this._hass),m=new Set,h=[];for(const e of c)for(const t of u.get(e.floor_id)||[])h.push({floor:e,area:t});for(const e of u.get(null)||[])h.push({floor:null,area:e});for(const{floor:n,area:c}of h){const u=(0,o.d6)(this._hass,c.area_id,this._entityCache);for(const o of u){const u=o.entity_id.split(".")[0],h=e[o.entity_id];if(!h)continue;const f={entity:o,domain:u,state:h,area:c,floor:n};if((0,l.JM)(f))continue;const v=h.attributes?.device_class||"",g=o.platform||"";if("battery"!==v||!o.device_id||m.has(o.device_id)){if("nut"===g&&d.test(o.entity_id))i.push(f);else if("power"===v&&p.test(o.entity_id))r.push(f);else if("power"===v&&!p.test(o.entity_id)){const e=Number(h.state);isNaN(e)||(s+=e),a.push(f)}}else m.add(o.device_id),t.push({entry:f,device:this._hass?.devices?.[o.device_id],deviceId:o.device_id,area:c,floor:n})}}return a.sort((e,t)=>(Number(t.state?.state)||0)-(Number(e.state?.state)||0)),{batteries:t,circuits:a,gridSensors:r,upsSensors:i,totalDraw:s}}_renderSystemStatus(e){const t=e.gridSensors.length>0?Number(e.gridSensors[0].state?.state)||0:e.totalDraw;let a=0,i=0;for(const t of e.batteries){const e=Number(t.entry.state?.state);isNaN(e)||(a+=e,i++)}return i>0&&(a=Math.round(a/i)),r.qy`
      ...
      <div class="eng-section">
        ...
        <div class="eng-sources-row">
          ...
          ${e.batteries.map(e=>{const t=Number(e.entry.state?.state)||0,a=(e.device?.name||e.entry.state?.attributes?.friendly_name||"BATTERY").toUpperCase(),s=t>50?"var(--lcars-ice)":t>20?"var(--lcars-sunflower)":"var(--lcars-tomato)";return r.qy`
              <div class="eng-source-card" @click=${()=>(0,i.Hv)(e.entry.entity.entity_id)}>
                ...
                <span class="eng-source-power" style="color:${s}">${t}%</span>
                <div class="eng-soc-bar"><div class="eng-soc-fill" style="width:${t}%; background:${s}"></div></div>
              </div>`})}
        </div>
...
`;function ne(e){const t=e.entity?.entity_id||"",a=(e.state,e.domain||"");if("lock"===a)return"lock";if("select"===a&&/solar/i.test(t))return"solar_mode";if("number"===a&&/max.*current/i.test(t))return"max_current_number";if("sensor"===a){if(/status_description/i.test(t))return"status";if(/current_mode/i.test(t))return"mode";if(/charging_power/i.test(t))return"charging_power";if(/charging_speed/i.test(t))return"charging_speed";if(/added_energy/i.test(t)&&!/green|grid/i.test(t))return"added_energy";if(/added_range/i.test(t))return"added_range";if(/(?:^|_)cost$/i.test(t))return"cost";if(/added_green_energy/i.test(t))return"green_energy";if(/added_grid_energy/i.test(t))return"grid_energy";if(/discharged_energy/i.test(t))return"discharged_energy";if(/state_of_charge/i.test(t))return"soc";if(/depot_price/i.test(t))return"depot_price";if(/max_available_power/i.test(t))return"max_available";if(/max_charging_current/i.test(t))return"max_current";if(/energy_price/i.test(t))return"energy_price"}return null}const oe=[{role:"status",label:"STATUS",color:null},{role:"mode",label:"MODE",color:"var(--lcars-data-accent, var(--lcars-sunflower))"}],le=[{role:"charging_power",label:"POWER",unit:"kW",color:null},{role:"charging_speed",label:"SPEED",unit:"km/h"},{role:"added_energy",label:"ADDED",unit:"kWh"},{role:"added_range",label:"RANGE",unit:"km"},{role:"cost",label:"COST",unit:"$"}],ce=[{role:"green_energy",label:"GREEN ENERGY",unit:"kWh",color:"var(--lcars-bluey, var(--lcars-ice))"},{role:"grid_energy",label:"GRID ENERGY",unit:"kWh",color:"var(--lcars-butterscotch)"},{role:"discharged_energy",label:"DISCHARGED",unit:"kWh",color:"var(--lcars-ice)"}],de=[{role:"soc",label:"SOC",unit:"%",color:null},{role:"depot_price",label:"DEPOT PRICE",unit:"$/kWh"}],pe=[{role:"max_available",label:"MAX AVAILABLE",unit:"kW"},{role:"max_current",label:"MAX CURRENT",unit:"A"},{role:"energy_price",label:"ENERGY PRICE",unit:"$/kWh"}];class ue extends x.j{get panelType(){return"ev_charger"}get defaultPanelTitle(){return"EV CHARGER"}get frameColor(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=e.get("charging_power")?.state?.state,r=null!=a?parseFloat(a):null;return(0,l.N)(t,r)}static get styles(){return[...super.styles,s.AM,se]}_entityMap(){if(this.__entityMapCache)return this.__entityMapCache;const e=new Map;for(const t of this._getAllEntities()){const a=ne(t);a&&!e.has(a)&&e.set(a,t)}return this.__entityMapCache=e,e}updated(e){super.updated(e),this.__entityMapCache=null}renderBadge(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=(0,l.WG)(t),i=this.frameColor;return r.qy`<lcars-summary-badge value="${a}" color="${i}"></lcars-summary-badge>`}renderContent(){const e=this._entityMap(),t=e.get("status")?.state?.state;if(!t||"unavailable"===t||"unknown"===t)return r.qy`
    ...
    `}static get styles(){return[i.Bx,r.AH`
      ...
      `]}getCardSize(){return Math.max(2,Math.ceil(this._sensorGroups.length/4)+1)}}customElements.get("lcars-internal-sensors-grid")||(customElements.define("lcars-internal-sensors-grid",m),s.g0.debug(l,"Custom element registered: lcars-internal-sensors-grid")),window.customCards=window.customCards||[],window.customCards.push({type:"lcars-internal-sensors-grid",name:"LCARS Internal Sensors Grid",description:"Ship-wide environmental monitoring grid",preview:!0})},958(e,t,a){var r=a(7349),i=a(8851),s=a(2622),n=a(7597),o=a(6930),l=a(4867);a(9411),a(6940);const c="all",d="climate",p=(new Set(["climate"]),new Set(["temperature","humidity"]),new Set(["fan","humidifier"]),new Set(["pm25","pm10","carbon_dioxide","volatile_organic_compounds","aqi","carbon_monoxide"])),u=new Set(["ha_blueair","vesync","homekit_controller"]);class m extends r.WF{static get properties(){return{hass:{type:Object},_config:{type:Object},filter:{type:String}}}constructor(){super(),this._hass=null,this._config={},this.filter=c,this._entityCache=new Map,this._onFilter=e=>{this.filter=e.detail.filter}}connectedCallback(){super.connectedCallback(),i.o6.addEventListener("lcars-ls-filter",this._onFilter)}disconnectedCallback(){super.disconnectedCallback(),i.o6.removeEventListener("lcars-ls-filter",this._onFilter)}setConfig(e){this._config=e||{}}set hass(e){const t=this._hass;this._hass=e,e&&t!==e&&(this._entityCache.clear(),this.requestUpdate("hass",t))}get hass(){return this._hass}getCardSize(){return 16}_discoverAll(){if(!this._hass)return{thermostats:[],purifiers:[],tempSensors:[],aqSensors:[],fans:[]};const e=(0,n.Qn)(this._hass),t=(0,n.E3)(this._hass),a=[],r=[],i=[],s=[],c=[],d=(this._hass.entities,this._hass.states||{}),m=[];for(const a of e){const e=t.get(a.floor_id)||[];for(const t of e)m.push({floor:a,area:t})}const h=t.get(null)||[];for(const e of h)m.push({floor:null,area:e});for(const{floor:e,area:t}of m){const n=(0,o.d6)(this._hass,t.area_id,this._entityCache);for(const o of n){const n=o.entity_id.split(".")[0],m=d[o.entity_id];if(!m)continue;const h={entity:o,domain:n,state:m,area:t,floor:e};if((0,l.JM)(h))continue;const f=m.attributes?.device_class||"",v=o.platform||"";"climate"===n&&/pool|spa|fridge|freezer/i.test(o.entity_id)||("climate"!==n?"fan"===n&&u.has(v)?r.push(h):"fan"!==n?"temperature"===f&&!/drive_|cpu_|phy_|display_|raw_|cook_|water_/i.test(o.entity_id)||"humidity"===f?i.push(h):(p.has(f)||/filter_life/i.test(o.entity_id))&&s.push(h):c.push(h):a.push(h))}}return{thermostats:a,purifiers:r,tempSensors:i,aqSensors:s,fans:c}}_renderOverview(e){const{thermostats:t,purifiers:a,tempSensors:i,aqSensors:s}=e;let n=0,o=0;for(const e of t){const t=e.state?.attributes?.hvac_action||e.state?.state||"idle";"heating"===t?n++:"cooling"===t&&o++}let l=0,c="GOOD";for(const e of s)if("aqi"===e.state?.attributes?.device_class){const t=Number(e.state?.state);!isNaN(t)&&t>l&&(l=t)}l>100?c="UNHEALTHY":l>50&&(c="MODERATE");let d=0,p=0;for(const e of i)if("temperature"===e.state?.attributes?.device_class){const t=Number(e.state?.state);!isNaN(t)&&t>0&&t<120&&(d+=t,p++)}const u=p>0?Math.round(d/p*10)/10:null;let m=0,h=0;for(const e of i)if("humidity"===e.state?.attributes?.device_class){const t=Number(e.state?.state);isNaN(t)||(m+=t,h++)}const f=h>0?Math.round(m/h):null,v=l<=50?"var(--lcars-ice)":l<=100?"var(--lcars-sunflower)":"var(--lcars-tomato)";return r.qy`
      <div class="ls-overview">
        <div class="ls-overview-card">
          <span class="ls-ov-title">AIR PURIFIERS</span>
          <span class="ls-ov-value">${a.length} UNITS</span>
          <span class="ls-ov-status" style="color:var(--lcars-ice)">ALL NORMAL</span>
        </div>
        <div class="ls-overview-card">
          <span class="ls-ov-title">THERMOSTATS</span>
          <span class="ls-ov-value">${t.length} ZONES</span>
          <span class="ls-ov-status">${n>0?`${n} HEATING`:o>0?`${o} COOLING`:"ALL IDLE"}</span>
        </div>
        <div class="ls-overview-card">
          <span class="ls-ov-title">AIR QUALITY</span>
          <span class="ls-ov-value" style="color:${v}">${l>0?l:"—"} AQI</span>
          <span class="ls-ov-status" style="color:${v}">${c}</span>
        </div>
        <div class="ls-overview-card">
          <span class="ls-ov-title">ENVIRONMENT</span>
          <span class="ls-ov-value">${null!=u?`${u}°`:"—"}</span>
          <span class="ls-ov-status">${null!=f?`${f}% HUMIDITY`:""}</span>
        </div>
      </div>
    `}_renderThermostats(e){return 0===e.length?"":r.qy`
      <div class="ls-section">
        ...
        <div class="ls-thermo-grid">
          ${e.map(e=>{const t=this._hass?.states?.[e.entity?.entity_id]||e.state,a=(e.area?.name||t?.attributes?.friendly_name||"").toUpperCase(),s=t?.attributes?.current_temperature,n=t?.attributes?.temperature,o=t?.attributes?.hvac_action||t?.state||"idle",l="heating"===o?"var(--lcars-butterscotch)":"cooling"===o?"var(--lcars-ice)":"var(--lcars-gray)",c=o.toUpperCase();return r.qy`
              <div class="ls-thermo-card" @click=${()=>(0,i.Hv)(e.entity.entity_id)}>
                <span class="ls-thermo-name">${a}</span>
                <span class="ls-thermo-temp" style="color:${l}">${null!=s?Math.round(10*s)/10+"°":"—"}</span>
                <span class="ls-thermo-action" style="color:${l}">${c}</span>
    ...
    `}_renderTempGrid(e){const t=new Map;for(const a of e){const e=a.area?.name||"Unknown";t.has(e)||t.set(e,{temp:null,humidity:null});const r=a.state?.attributes?.device_class,i=Number(a.state?.state);if("temperature"===r&&!isNaN(i)){const r=t.get(e);(!r.temp||i>0)&&(r.temp={entry:a,val:i})}"humidity"!==r||isNaN(i)||(t.get(e).humidity={entry:a,val:i})}const a=[...t.entries()].filter(([,e])=>e.temp||e.humidity).sort((e,t)=>e[0].localeCompare(t[0]));return 0===a.length?"":r.qy`
      <div class="ls-section">
        <div class="ls-section-header">
          ...
          <span class="ls-section-line"></span>
          <span class="ls-sensor-count">${a.length} ZONES</span>
        </div>
        <div class="ls-purifier-table">
          <div class="ls-table-header">
            <span class="ls-th">LOCATION</span>
    ...
    `}_renderAirQuality(e){const t={};for(const a of e){const e=a.state?.attributes?.device_class||"",r=a.entity?.entity_id||"",i=Number(a.state?.state);isNaN(i)||("aqi"===e&&(!t.aqi||i>t.aqi.val)&&(t.aqi={val:i,entry:a}),"pm25"!==e&&!/pm_?2_?5/i.test(r)||t.pm25||(t.pm25={val:i,entry:a}),"pm10"!==e&&!/pm_?10/i.test(r)||t.pm10||(t.pm10={val:i,entry:a}),"carbon_dioxide"!==e&&!/co2|carbon_dioxide/i.test(r)||t.co2||(t.co2={val:i,entry:a}),"volatile_organic_compounds"!==e&&!/voc/i.test(r)||t.voc||(t.voc={val:i,entry:a}))}if(0===Object.keys(t).length)return"";const a=t.aqi?.val||0,s=a<=50?"GOOD":a<=100?"MODERATE":a<=150?"SENSITIVE":"UNHEALTHY",n=a<=50?"var(--lcars-ice)":a<=100?"var(--lcars-sunflower)":"var(--lcars-tomato)";return r.qy`
      <div class="ls-section">
        <div class="ls-section-header">
        ...
        <div class="ls-aq-panel">
          <div class="ls-aq-hero">
            <span class="ls-aq-score" style="color:${n}">${a||"—"}</span>
            <span class="ls-aq-label">AQI</span>
            <span class="ls-aq-status" style="color:${n}">${s}</span>
          </div>
          <div class="ls-aq-metrics">
            ...
            ${t.co2?r.qy`<div class="ls-aq-row" @click=${()=>(0,i.Hv)(t.co2.entry.entity.entity_id)}><span class="ls-aq-metric-name">CO₂</span><span class="ls-aq-metric-val">${t.co2.val} ppm</span></div>`:""}
    ...
    `}render(){if(!this._hass)return r.qy`<div class="ls-loading">INITIALIZING LIFE SUPPORT...</div>`;const e=this._discoverAll(),t=this.filter;return r.qy`
      <div class="ls-dashboard">
        ...
        ${t===c||t===d?this._renderThermostats(e.thermostats):""}
        ${t===c||"air"===t?this._renderAirQuality(e.aqSensors):""}
        ${t===c||"air"===t?this._renderPurifiers(e.purifiers,e.aqSensors):""}
        ${t===c||t===d?this._renderTempGrid(e.tempSensors):""}
      </div>
    `}static get styles(){return[s.Bx,r.AH`
        :host { display: block; }

        ...
        <div class="tac-summary" style="--summary-color:${this._getSummaryColor(t.alarmState)}">
          ...
          ${i.length>0?r.qy`
            <span class="tac-summary__block">
              ...
              <span class="tac-summary__value">${i.filter(e=>"unavailable"!==(this._hass?.states?.[e.entity?.entity_id]||e.state)?.state).length}/${i.length} ACTIVE</span>
            </span>
          `:""}
        </div>

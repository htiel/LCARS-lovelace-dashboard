...
`;function ee(e){const t=e.entity?.entity_id||"",a=(e.state,e.domain||"");if("lock"===a)return"lock";if("select"===a&&/solar/i.test(t))return"solar_mode";if("number"===a&&/max.*current/i.test(t))return"max_current_number";if("sensor"===a){if(/status_description/i.test(t))return"status";if(/current_mode/i.test(t))return"mode";if(/charging_power/i.test(t))return"charging_power";if(/charging_speed/i.test(t))return"charging_speed";if(/added_energy/i.test(t)&&!/green|grid/i.test(t))return"added_energy";if(/added_range/i.test(t))return"added_range";if(/(?:^|_)cost$/i.test(t))return"cost";if(/added_green_energy/i.test(t))return"green_energy";if(/added_grid_energy/i.test(t))return"grid_energy";if(/discharged_energy/i.test(t))return"discharged_energy";if(/state_of_charge/i.test(t))return"soc";if(/depot_price/i.test(t))return"depot_price";if(/max_available_power/i.test(t))return"max_available";if(/max_charging_current/i.test(t))return"max_current";if(/energy_price/i.test(t))return"energy_price"}return null}const te=[{role:"status",label:"STATUS",color:null},{role:"mode",label:"MODE",color:"var(--lcars-data-accent, var(--lcars-sunflower))"}],ae=[{role:"charging_power",label:"POWER",unit:"kW",color:null},{role:"charging_speed",label:"SPEED",unit:"km/h"},{role:"added_energy",label:"ADDED",unit:"kWh"},{role:"added_range",label:"RANGE",unit:"km"},{role:"cost",label:"COST",unit:"$"}],re=[{role:"green_energy",label:"GREEN ENERGY",unit:"kWh",color:"var(--lcars-bluey, var(--lcars-ice))"},{role:"grid_energy",label:"GRID ENERGY",unit:"kWh",color:"var(--lcars-butterscotch)"},{role:"discharged_energy",label:"DISCHARGED",unit:"kWh",color:"var(--lcars-ice)"}],se=[{role:"soc",label:"SOC",unit:"%",color:null},{role:"depot_price",label:"DEPOT PRICE",unit:"$/kWh"}],ie=[{role:"max_available",label:"MAX AVAILABLE",unit:"kW"},{role:"max_current",label:"MAX CURRENT",unit:"A"},{role:"energy_price",label:"ENERGY PRICE",unit:"$/kWh"}];customElements.get("lcars-ev-charger-panel")||customElements.define("lcars-ev-charger-panel",class extends E{get panelType(){return"ev_charger"}get defaultPanelTitle(){return"EV CHARGER"}get frameColor(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=e.get("charging_power")?.state?.state,r=null!=a?parseFloat(a):null;return(0,l.N)(t,r)}static get styles(){return[...super.styles,i.AM,J]}_entityMap(){if(this.__entityMapCache)return this.__entityMapCache;const e=new Map;for(const t of this._getAllEntities()){const a=ee(t);a&&!e.has(a)&&e.set(a,t)}return this.__entityMapCache=e,e}updated(e){super.updated(e),this.__entityMapCache=null}renderBadge(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=(0,l.WG)(t),s=this.frameColor;return r.qy`<lcars-summary-badge value="${a}" color="${s}"></lcars-summary-badge>`}renderContent(){const e=this._entityMap(),t=e.get("status")?.state?.state;if(!t||"unavailable"===t||"unknown"===t)return r.qy`
    ...
    `}static get styles(){return[s.Bx,r.AH`
      ...
      `]}getCardSize(){return Math.max(2,Math.ceil(this._sensorGroups.length/4)+1)}}customElements.get("lcars-internal-sensors-grid")||(customElements.define("lcars-internal-sensors-grid",m),i.g0.debug(l,"Custom element registered: lcars-internal-sensors-grid")),window.customCards=window.customCards||[],window.customCards.push({type:"lcars-internal-sensors-grid",name:"LCARS Internal Sensors Grid",description:"Ship-wide environmental monitoring grid",preview:!0})},958(e,t,a){var r=a(7349),s=a(8851),i=a(2622),n=a(7597),o=a(6930),l=a(9784),c=a(261),d=a(4867);a(9411);const p="all",u="climate",m="air",h=(new Set(["climate"]),new Set(["temperature","humidity"]),new Set(["fan","humidifier"]),new Set(["pm25","pm10","carbon_dioxide","volatile_organic_compounds","volatile_organic_compounds_parts","aqi","carbon_monoxide"])),f=new Set(["ha_blueair","vesync","homekit_controller"]);class v extends r.WF{static get properties(){return{hass:{type:Object},_config:{type:Object},filter:{type:String}}}constructor(){super(),this._hass=null,this._config={},this.filter=p,this._entityCache=new Map,this._aqHistoryCache=new Map,this._aqSparklines={},this._aqHistoryData=null,this._envHistoryData=null,this._onFilter=e=>{this.filter=e.detail.filter}}connectedCallback(){super.connectedCallback(),s.o6.addEventListener("lcars-ls-filter",this._onFilter)}disconnectedCallback(){super.disconnectedCallback(),s.o6.removeEventListener("lcars-ls-filter",this._onFilter)}setConfig(e){this._config=e||{}}set hass(e){const t=this._hass;this._hass=e,e&&t!==e&&(this._entityCache.clear(),this._aqSparklinesFetched=!1,this._aqHistoryFetched=!1,this._envHistoryFetched=!1,this.requestUpdate("hass",t))}get hass(){return this._hass}getCardSize(){return 16}_discoverAll(){if(!this._hass)return{thermostats:[],purifiers:[],tempSensors:[],aqSensors:[],fans:[]};const e=[],t=[],a=[],r=[],s=[],i=(this._hass.entities,this._hass.states||{}),l=(0,n.He)(this._hass);for(const{floor:n,area:c}of l){const l=(0,o.d6)(this._hass,c.area_id,this._entityCache);for(const o of l){const l=o.entity_id.split(".")[0],p=i[o.entity_id];if(!p)continue;const u={entity:o,domain:l,state:p,area:c,floor:n};if((0,d.JM)(u))continue;const m=p.attributes?.device_class||"",v=o.platform||"";"climate"===l&&/pool|spa|fridge|freezer/i.test(o.entity_id)||("climate"!==l?"fan"===l&&f.has(v)?t.push(u):"fan"!==l?"temperature"===m&&!/drive_|cpu_|phy_|display_|raw_|cook_|water_/i.test(o.entity_id)||"humidity"===m?a.push(u):(h.has(m)||/filter_life/i.test(o.entity_id)||/_score$/i.test(o.entity_id))&&r.push(u):s.push(u):e.push(u))}}return{thermostats:e,purifiers:t,tempSensors:a,aqSensors:r,fans:s}}_renderOverview(e){const{thermostats:t,purifiers:a,tempSensors:s,aqSensors:i}=e;let n=0,o=0;for(const e of t){const t=e.state?.attributes?.hvac_action||e.state?.state||"idle";"heating"===t?n++:"cooling"===t&&o++}let c=0,d="GOOD";for(const e of i)if("aqi"===e.state?.attributes?.device_class){const t=Number(e.state?.state);!isNaN(t)&&t>c&&(c=t)}c>100?d="UNHEALTHY":c>50&&(d="MODERATE");let p=0,h=0;for(const e of s)if("temperature"===e.state?.attributes?.device_class){const t=Number(e.state?.state);!isNaN(t)&&t>0&&t<120&&(p+=t,h++)}const f=h>0?Math.round(p/h*10)/10:null;let v=0,g=0;for(const e of s)if("humidity"===e.state?.attributes?.device_class){const t=Number(e.state?.state);isNaN(t)||(v+=t,g++)}const b=g>0?Math.round(v/g):null,y=c<=50?"#44cc88":c<=100?"#ffcc99":"#ff5555",_=c<=50?"#44cc88":c<=100?"var(--lcars-sunflower)":"var(--lcars-tomato)",w=t.length>0?Math.round(t.reduce((e,t)=>e+(Number(t.state?.attributes?.current_temperature)||0),0)/t.length):null,x=n>0?"#ff9966":o>0?"#99ccff":"#666688",$=a.filter(e=>"on"===(this._hass?.states?.[e.entity?.entity_id]||e.state)?.state).length,k=$===a.length?"#44cc88":$>0?"#99ccff":"#666688",S=null!=f?f<68?"#8899ff":f<=76?"#44cc88":"#ff9966":"#99ccff";return r.qy`

...
`;class l extends r.WF{static get properties(){return{_hass:{type:Object},_config:{type:Object},_order:{type:Array},_columnOverrides:{type:Object},_selected:{type:String}}}set hass(e){this._hass=e}setConfig(e){this._config=e;const t=e?.panels||[];this._order=t.map(e=>e.panelId),this._columnOverrides={...e?.column_overrides||{}},this._selected=e?.panel_id||t[0]?.panelId||""}_getPanelInfo(e){return(this._config?.panels||[]).find(t=>t.panelId===e)}_isIllumination(e){const t=this._getPanelInfo(e);return t?.panelType===n.sv}_getColumn(e){if(this._isIllumination(e))return"full";const t=this._getPanelInfo(e);return this._columnOverrides[e]||this._columnOverrides[t?.panelType]||n.uC[t?.panelType]||"left"}_getLabel(e){const t=this._getPanelInfo(e);return t?t.label||t.panelType.replace(/_/g," "):e}_select(e){this._selected=e}_moveUp(){const e=this._getColumn(this._selected),t=this._order.filter(t=>this._getColumn(t)===e),a=t.indexOf(this._selected);if(a<=0)return;const r=this._order.indexOf(this._selected),i=this._order.indexOf(t[a-1]),s=[...this._order];[s[i],s[r]]=[s[r],s[i]],this._order=s}_moveDown(){const e=this._getColumn(this._selected),t=this._order.filter(t=>this._getColumn(t)===e),a=t.indexOf(this._selected);if(a<0||a>=t.length-1)return;const r=this._order.indexOf(this._selected),i=this._order.indexOf(t[a+1]),s=[...this._order];[s[r],s[i]]=[s[i],s[r]],this._order=s}_moveLeft(){this._isIllumination(this._selected)||"left"!==this._getColumn(this._selected)&&(this._columnOverrides={...this._columnOverrides,[this._selected]:"left"})}_moveRight(){this._isIllumination(this._selected)||"right"!==this._getColumn(this._selected)&&(this._columnOverrides={...this._columnOverrides,[this._selected]:"right"})}async _save(){if(this._hass&&this._config?.area_id)try{await this._hass.callWS({type:"lcars_dashboard/panel_order/set",area_id:this._config.area_id,panel_order:JSON.stringify(this._order)});const e={};for(const[t,a]of Object.entries(this._columnOverrides)){const r=this._getPanelInfo(t);a!==(n.uC[r?.panelType]||"left")&&(e[t]=a)}await this._hass.callWS({type:"lcars_dashboard/panel_column/set",area_id:this._config.area_id,panel_columns:JSON.stringify(e)}),(0,s.rC)("lcars_dashboard_reload")}catch(e){console.error("LCARS Edit: Panel layout save failed",e)}}async _reset(){if(this._hass&&this._config?.area_id)try{await this._hass.callWS({type:"lcars_dashboard/panel_order/set",area_id:this._config.area_id,panel_order:JSON.stringify([])}),await this._hass.callWS({type:"lcars_dashboard/panel_column/set",area_id:this._config.area_id,panel_columns:JSON.stringify({})});const e=this._config?.panels||[];this._order=e.map(e=>e.panelId),this._columnOverrides={},(0,s.rC)("lcars_dashboard_reload")}catch(e){console.error("LCARS Edit: Panel layout reset failed",e)}}static get styles(){return[i.Bx,o]}_renderPanelItem(e,t){const a=e===this._selected,i=this._isIllumination(e),s=this._getPanelInfo(e),n=s?.panelType?.replace(/_/g," ")||"",o=this._getLabel(e),l=s?.deviceId&&o.toLowerCase()!==n.toLowerCase();return r.qy`
    ...
    `}getCardSize(){return 5}}customElements.get("lcars-edit-panel-order-card")||customElements.define("lcars-edit-panel-order-card",l)},5316(e,t,a){var r=a(7349),i=a(8851),s=a(2622),n=a(7597),o=a(6930),l=a(4867),c=a(9411);a(6940),a(6564),new Set(["battery","power","energy","voltage","current"]);const d=/ups|battery_charge|battery_runtime|battery_voltage/i,p=/grid|mains|mainsfromgrid|main.*load|total.*power|vueg3.*main|shelly.*total|3em.*total/i,u=new Set(["ecoflow_cloud","nut","victron","tesla_powerwall","solaredge"]),m=new Set(["wallbox","insteon","blink","simplisafe","tile","switchbot","unifiprotect","unifi","mobile_app","nest_protect"]),h=/motion.sensor|remote|phone|tablet|watch|tile|tag|lock|camera|protect|switch.?bot|wallbox|vilya|charger|thermostat|meter|doorbell/i;class f extends r.WF{static get properties(){return{hass:{type:Object},_config:{type:Object},filter:{type:String}}}constructor(){super(),this._hass=null,this._config={},this.filter="all",this._entityCache=new Map,this._onFilter=e=>{this.filter=e.detail.filter}}connectedCallback(){super.connectedCallback(),i.o6.addEventListener("lcars-eng-filter",this._onFilter)}disconnectedCallback(){super.disconnectedCallback(),i.o6.removeEventListener("lcars-eng-filter",this._onFilter)}setConfig(e){this._config=e||{}}set hass(e){const t=this._hass;this._hass=e,e&&t!==e&&(this._entityCache.clear(),this.requestUpdate("hass",t))}get hass(){return this._hass}getCardSize(){return 16}_discoverAll(){if(!this._hass)return{batteries:[],circuits:[],gridSensors:[],upsSensors:[],totalDraw:0};const e=this._hass.states||{},t=[],a=[],r=[],i=[];let s=0;const c=(0,n.Qn)(this._hass),f=(0,n.E3)(this._hass),v=new Set,g=[];for(const e of c)for(const t of f.get(e.floor_id)||[])g.push({floor:e,area:t});for(const e of f.get(null)||[])g.push({floor:null,area:e});for(const{floor:n,area:c}of g){const f=(0,o.d6)(this._hass,c.area_id,this._entityCache);for(const o of f){const f=o.entity_id.split(".")[0],g=e[o.entity_id];if(!g)continue;const b={entity:o,domain:f,state:g,area:c,floor:n};if((0,l.JM)(b))continue;const y=g.attributes?.device_class||"",_=o.platform||"";if("battery"===y&&o.device_id&&!v.has(o.device_id)){if(m.has(_))continue;const e=this._hass?.devices?.[o.device_id],a=(e?.name||o.entity_id||"").toLowerCase();if(h.test(a)||h.test(o.entity_id))continue;if(!u.has(_)&&!/ecoflow|river|delta|powerwall|ups/i.test(a))continue;v.add(o.device_id),t.push({entry:b,device:e,deviceId:o.device_id,area:c,floor:n});continue}if("nut"===_&&d.test(o.entity_id))i.push(b);else if("power"===y&&p.test(o.entity_id))r.push(b);else if("power"===y&&!p.test(o.entity_id)){const e=Number(g.state);isNaN(e)||(s+=e),a.push(b)}}}a.sort((e,t)=>(Number(t.state?.state)||0)-(Number(e.state?.state)||0));const b=this._hass?.entities||{};for(const a of t){a.siblings={};for(const[t,r]of Object.entries(e)){const e=b[t];if(!e||e.device_id!==a.deviceId)continue;const i=r.attributes?.device_class||"";t.toLowerCase(),"voltage"!==i||a.siblings.voltage?"temperature"!==i||/pcs/i.test(t)||a.siblings.temp?"power"===i&&/total.*in/i.test(t)&&!a.siblings.totalIn?a.siblings.totalIn=r:"power"===i&&/total.*out/i.test(t)&&!a.siblings.totalOut?a.siblings.totalOut=r:/remaining.*time|discharge.*remain|charge.*remain/i.test(t)&&!a.siblings.runtime?a.siblings.runtime=r:/charging.*state|battery.*state/i.test(t)&&!a.siblings.chargeState&&(a.siblings.chargeState=r):a.siblings.temp=r:a.siblings.voltage=r}}return{batteries:t,circuits:a,gridSensors:r,upsSensors:i,totalDraw:s}}_getGridPower(e){const t=e.gridSensors.find(e=>"power"===e.state?.attributes?.device_class&&Number(e.state?.state)>0);return t?Number(t.state.state):e.totalDraw}_renderSystemStatus(e){const t=this._getGridPower(e);let a=0,i=0;for(const t of e.batteries){const e=Number(t.entry.state?.state);isNaN(e)||(a+=e,i++)}return i>0&&(a=Math.round(a/i)),r.qy`
      ...
      </div>`}_renderSources(e){const t=this._getGridPower(e);return r.qy`
      <div class="eng-section">
        ...
        <div class="eng-sources-row">
          <div class="eng-source-card" @click=${()=>e.gridSensors[0]&&(0,i.Hv)(e.gridSensors[0].entity.entity_id)}>
            <span class="eng-source-title" style="color:var(--lcars-ice)">GRID</span>
            <span class="eng-source-power">${(0,c.ZV)(t,0)} W</span>
          ...
          ${e.batteries.map(e=>{const t=Number(e.entry.state?.state)||0,a=(e.device?.name||e.entry.state?.attributes?.friendly_name||"BATTERY").toUpperCase(),s=t>50?"#99ccff":t>20?"#ffcc99":"#ff5555",n=t>50?"var(--lcars-ice)":t>20?"var(--lcars-sunflower)":"var(--lcars-tomato)",o=e.siblings?.totalIn&&Number(e.siblings.totalIn.state)||0,l=e.siblings?.totalOut&&Number(e.siblings.totalOut.state)||0,d=o>l+5,p=l>o+5,u=d?`▲ CHARGING ${(0,c.ZV)(o,0)}W`:p?`▼ DISCHARGING ${(0,c.ZV)(l,0)}W`:"━ IDLE",m=d?"var(--lcars-ice)":p?"var(--lcars-butterscotch)":"var(--lcars-gray)",h=d?"rgba(153,204,255,0.15)":p?"rgba(255,153,102,0.15)":"rgba(102,102,136,0.15)",f=e.siblings?.voltage?Number(e.siblings.voltage.state):null,v=e.siblings?.temp?Number(e.siblings.temp.state):null,g=e.siblings?.runtime?.state||null,b=(e.siblings,e.device?.model||"");return r.qy`
              <div class="eng-source-card eng-battery-card" style="border-color:${n}"
                ...
                ${function(e,t,a,i,s){const n=2*Math.PI*32,o=n*(1-Math.min(1,Math.max(0,e/100)));return r.JW`
    <svg viewBox="0 0 ${a} ${a}" width="${a}" height="${a}" class="ring-gauge" role="meter"
         aria-valuenow="${e}" aria-valuemin="0" aria-valuemax="${100}" aria-label="${s}: ${e}">
      <circle cx="${36}" cy="${36}" r="${32}" fill="none" stroke="rgba(153,204,255,0.12)" stroke-width="4" />
      <circle cx="${36}" cy="${36}" r="${32}" fill="none" stroke="${i}" stroke-width="4"
              stroke-dasharray="${n}" stroke-dashoffset="${o}"
              stroke-linecap="round" transform="rotate(-90 ${36} ${36})"
              style="transition: stroke-dashoffset 500ms ease" />
      <text x="${36}" y="${32}" text-anchor="middle" dominant-baseline="central"
      ...
      ${""}
                ...
                <div class="eng-battery-telemetry">
                  ${null!=f?r.qy`<span class="eng-bt-key">VOLTAGE</span><span class="eng-bt-val">${f}V</span>`:""}
                  ${null!=v?r.qy`<span class="eng-bt-key">TEMP</span><span class="eng-bt-val">${Math.round(v)}°</span>`:""}
                  ${g?r.qy`<span class="eng-bt-key">RUNTIME</span><span class="eng-bt-val">${g}</span>`:""}
                </div>
              </div>`})}
        </div>
      ...
      </div>`}_renderCircuits(e){if(0===e.length)return"";const t=e.filter(e=>Number(e.state?.state)>1),a=t.slice(0,12),s=t.length-a.length;return r.qy`
      <div class="eng-section">
        ...
        <div class="eng-circuit-grid">
          ${a.map(e=>{const t=(e.state?.attributes?.friendly_name||e.entity?.entity_id||"").replace(/_power.*$/i,"").replace(/_/g," ").toUpperCase(),a=Number(e.state?.state)||0,s=Math.min(100,a/Math.max(a,500)*100),n=a>1e3?"var(--lcars-tomato)":a>500?"var(--lcars-butterscotch)":a>200?"var(--lcars-sunflower)":"var(--lcars-ice)";return r.qy`
              <div class="eng-circuit-card" @click=${()=>(0,i.Hv)(e.entity.entity_id)}>
                <span class="eng-circuit-name">${t}</span>
                <span class="eng-circuit-watts">${(0,c.ZV)(a,0)} W</span>
                <div class="eng-circuit-bar"><div class="eng-circuit-fill" style="width:${s}%; background:${n}"></div></div>
              </div>`})}
        </div>
...
`;function ne(e){const t=e.entity?.entity_id||"",a=(e.state,e.domain||"");if("lock"===a)return"lock";if("select"===a&&/solar/i.test(t))return"solar_mode";if("number"===a&&/max.*current/i.test(t))return"max_current_number";if("sensor"===a){if(/status_description/i.test(t))return"status";if(/current_mode/i.test(t))return"mode";if(/charging_power/i.test(t))return"charging_power";if(/charging_speed/i.test(t))return"charging_speed";if(/added_energy/i.test(t)&&!/green|grid/i.test(t))return"added_energy";if(/added_range/i.test(t))return"added_range";if(/(?:^|_)cost$/i.test(t))return"cost";if(/added_green_energy/i.test(t))return"green_energy";if(/added_grid_energy/i.test(t))return"grid_energy";if(/discharged_energy/i.test(t))return"discharged_energy";if(/state_of_charge/i.test(t))return"soc";if(/depot_price/i.test(t))return"depot_price";if(/max_available_power/i.test(t))return"max_available";if(/max_charging_current/i.test(t))return"max_current";if(/energy_price/i.test(t))return"energy_price"}return null}const oe=[{role:"status",label:"STATUS",color:null},{role:"mode",label:"MODE",color:"var(--lcars-data-accent, var(--lcars-sunflower))"}],le=[{role:"charging_power",label:"POWER",unit:"kW",color:null},{role:"charging_speed",label:"SPEED",unit:"km/h"},{role:"added_energy",label:"ADDED",unit:"kWh"},{role:"added_range",label:"RANGE",unit:"km"},{role:"cost",label:"COST",unit:"$"}],ce=[{role:"green_energy",label:"GREEN ENERGY",unit:"kWh",color:"var(--lcars-bluey, var(--lcars-ice))"},{role:"grid_energy",label:"GRID ENERGY",unit:"kWh",color:"var(--lcars-butterscotch)"},{role:"discharged_energy",label:"DISCHARGED",unit:"kWh",color:"var(--lcars-ice)"}],de=[{role:"soc",label:"SOC",unit:"%",color:null},{role:"depot_price",label:"DEPOT PRICE",unit:"$/kWh"}],pe=[{role:"max_available",label:"MAX AVAILABLE",unit:"kW"},{role:"max_current",label:"MAX CURRENT",unit:"A"},{role:"energy_price",label:"ENERGY PRICE",unit:"$/kWh"}];class ue extends x.j{get panelType(){return"ev_charger"}get defaultPanelTitle(){return"EV CHARGER"}get frameColor(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=e.get("charging_power")?.state?.state,r=null!=a?parseFloat(a):null;return(0,l.N)(t,r)}static get styles(){return[...super.styles,s.AM,se]}_entityMap(){if(this.__entityMapCache)return this.__entityMapCache;const e=new Map;for(const t of this._getAllEntities()){const a=ne(t);a&&!e.has(a)&&e.set(a,t)}return this.__entityMapCache=e,e}updated(e){super.updated(e),this.__entityMapCache=null}renderBadge(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=(0,l.WG)(t),i=this.frameColor;return r.qy`<lcars-summary-badge value="${a}" color="${i}"></lcars-summary-badge>`}renderContent(){const e=this._entityMap(),t=e.get("status")?.state?.state;if(!t||"unavailable"===t||"unknown"===t)return r.qy`
  ...
  `}a(9411),a(6940);const d="all",p="climate",u=(new Set(["climate"]),new Set(["temperature","humidity"]),new Set(["fan","humidifier"]),new Set(["pm25","pm10","carbon_dioxide","volatile_organic_compounds","aqi","carbon_monoxide"])),m=new Set(["ha_blueair","vesync","homekit_controller"]);class h extends r.WF{static get properties(){return{hass:{type:Object},_config:{type:Object},filter:{type:String}}}constructor(){super(),this._hass=null,this._config={},this.filter=d,this._entityCache=new Map,this._onFilter=e=>{this.filter=e.detail.filter}}connectedCallback(){super.connectedCallback(),i.o6.addEventListener("lcars-ls-filter",this._onFilter)}disconnectedCallback(){super.disconnectedCallback(),i.o6.removeEventListener("lcars-ls-filter",this._onFilter)}setConfig(e){this._config=e||{}}set hass(e){const t=this._hass;this._hass=e,e&&t!==e&&(this._entityCache.clear(),this.requestUpdate("hass",t))}get hass(){return this._hass}getCardSize(){return 16}_discoverAll(){if(!this._hass)return{thermostats:[],purifiers:[],tempSensors:[],aqSensors:[],fans:[]};const e=(0,n.Qn)(this._hass),t=(0,n.E3)(this._hass),a=[],r=[],i=[],s=[],c=[],d=(this._hass.entities,this._hass.states||{}),p=[];for(const a of e){const e=t.get(a.floor_id)||[];for(const t of e)p.push({floor:a,area:t})}const h=t.get(null)||[];for(const e of h)p.push({floor:null,area:e});for(const{floor:e,area:t}of p){const n=(0,o.d6)(this._hass,t.area_id,this._entityCache);for(const o of n){const n=o.entity_id.split(".")[0],p=d[o.entity_id];if(!p)continue;const h={entity:o,domain:n,state:p,area:t,floor:e};if((0,l.JM)(h))continue;const f=p.attributes?.device_class||"",v=o.platform||"";"climate"===n&&/pool|spa|fridge|freezer/i.test(o.entity_id)||("climate"!==n?"fan"===n&&m.has(v)?r.push(h):"fan"!==n?"temperature"===f&&!/drive_|cpu_|phy_|display_|raw_|cook_|water_/i.test(o.entity_id)||"humidity"===f?i.push(h):(u.has(f)||/filter_life/i.test(o.entity_id))&&s.push(h):c.push(h):a.push(h))}}return{thermostats:a,purifiers:r,tempSensors:i,aqSensors:s,fans:c}}_renderOverview(e){const{thermostats:t,purifiers:a,tempSensors:i,aqSensors:s}=e;let n=0,o=0;for(const e of t){const t=e.state?.attributes?.hvac_action||e.state?.state||"idle";"heating"===t?n++:"cooling"===t&&o++}let l=0,d="GOOD";for(const e of s)if("aqi"===e.state?.attributes?.device_class){const t=Number(e.state?.state);!isNaN(t)&&t>l&&(l=t)}l>100?d="UNHEALTHY":l>50&&(d="MODERATE");let p=0,u=0;for(const e of i)if("temperature"===e.state?.attributes?.device_class){const t=Number(e.state?.state);!isNaN(t)&&t>0&&t<120&&(p+=t,u++)}const m=u>0?Math.round(p/u*10)/10:null;let h=0,f=0;for(const e of i)if("humidity"===e.state?.attributes?.device_class){const t=Number(e.state?.state);isNaN(t)||(h+=t,f++)}const v=f>0?Math.round(h/f):null,g=l<=50?"#99ccff":l<=100?"#ffcc99":"#ff5555",b=l<=50?"var(--lcars-ice)":l<=100?"var(--lcars-sunflower)":"var(--lcars-tomato)",y=t.length>0?Math.round(t.reduce((e,t)=>e+(Number(t.state?.attributes?.current_temperature)||0),0)/t.length):null,_=n>0?"#ff9966":o>0?"#99ccff":"#666688";return r.qy`
    ...
    `}_renderAirQuality(e){const t={};for(const a of e){const e=a.state?.attributes?.device_class||"",r=a.entity?.entity_id||"",i=Number(a.state?.state);isNaN(i)||("aqi"===e&&(!t.aqi||i>t.aqi.val)&&(t.aqi={val:i,entry:a}),"pm25"!==e&&!/pm_?2_?5/i.test(r)||t.pm25||(t.pm25={val:i,entry:a}),"pm10"!==e&&!/pm_?10/i.test(r)||t.pm10||(t.pm10={val:i,entry:a}),"carbon_dioxide"!==e&&!/co2|carbon_dioxide/i.test(r)||t.co2||(t.co2={val:i,entry:a}),"volatile_organic_compounds"!==e&&!/voc/i.test(r)||t.voc||(t.voc={val:i,entry:a}))}if(0===Object.keys(t).length)return"";const a=t.aqi?.val||0,s=a<=50?"GOOD":a<=100?"MODERATE":a<=150?"SENSITIVE":"UNHEALTHY",n=a<=50?"#99ccff":a<=100?"#ffcc99":"#ff5555",o=a<=50?"var(--lcars-ice)":a<=100?"var(--lcars-sunflower)":"var(--lcars-tomato)",l=t.co2?.val||0,d=l>1500?"var(--lcars-tomato)":l>1e3?"var(--lcars-sunflower)":"var(--lcars-ice)",p=l>1500?" ⚠ HIGH":l>1e3?" ⚠ ELEVATED":"";return r.qy`
      <div class="ls-section">
        <div class="ls-section-header">
        ...
        <div class="ls-aq-panel">
          <div class="ls-aq-hero">
            ${c(Math.min(a,300),300,96,n,a>0?`${a}`:"—","AQI")}
            <span class="ls-aq-status" style="color:${o}">${s}</span>
          </div>
          <div class="ls-aq-metrics">
            ...
            ${t.co2?r.qy`<div class="ls-aq-row" @click=${()=>(0,i.Hv)(t.co2.entry.entity.entity_id)}><span class="ls-aq-metric-name">CO₂</span><span class="ls-aq-metric-val" style="color:${d}">${t.co2.val} ppm${p}</span></div>`:""}

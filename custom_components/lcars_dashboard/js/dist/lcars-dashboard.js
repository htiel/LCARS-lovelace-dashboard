...
`;function ee(e){const t=e.entity?.entity_id||"",a=(e.state,e.domain||"");if("lock"===a)return"lock";if("select"===a&&/solar/i.test(t))return"solar_mode";if("number"===a&&/max.*current/i.test(t))return"max_current_number";if("sensor"===a){if(/status_description/i.test(t))return"status";if(/current_mode/i.test(t))return"mode";if(/charging_power/i.test(t))return"charging_power";if(/charging_speed/i.test(t))return"charging_speed";if(/added_energy/i.test(t)&&!/green|grid/i.test(t))return"added_energy";if(/added_range/i.test(t))return"added_range";if(/(?:^|_)cost$/i.test(t))return"cost";if(/added_green_energy/i.test(t))return"green_energy";if(/added_grid_energy/i.test(t))return"grid_energy";if(/discharged_energy/i.test(t))return"discharged_energy";if(/state_of_charge/i.test(t))return"soc";if(/depot_price/i.test(t))return"depot_price";if(/max_available_power/i.test(t))return"max_available";if(/max_charging_current/i.test(t))return"max_current";if(/energy_price/i.test(t))return"energy_price"}return null}const te=[{role:"status",label:"STATUS",color:null},{role:"mode",label:"MODE",color:"var(--lcars-data-accent, var(--lcars-sunflower))"}],ae=[{role:"charging_power",label:"POWER",unit:"kW",color:null},{role:"charging_speed",label:"SPEED",unit:"km/h"},{role:"added_energy",label:"ADDED",unit:"kWh"},{role:"added_range",label:"RANGE",unit:"km"},{role:"cost",label:"COST",unit:"$"}],re=[{role:"green_energy",label:"GREEN ENERGY",unit:"kWh",color:"var(--lcars-bluey, var(--lcars-ice))"},{role:"grid_energy",label:"GRID ENERGY",unit:"kWh",color:"var(--lcars-butterscotch)"},{role:"discharged_energy",label:"DISCHARGED",unit:"kWh",color:"var(--lcars-ice)"}],se=[{role:"soc",label:"SOC",unit:"%",color:null},{role:"depot_price",label:"DEPOT PRICE",unit:"$/kWh"}],ie=[{role:"max_available",label:"MAX AVAILABLE",unit:"kW"},{role:"max_current",label:"MAX CURRENT",unit:"A"},{role:"energy_price",label:"ENERGY PRICE",unit:"$/kWh"}];customElements.get("lcars-ev-charger-panel")||customElements.define("lcars-ev-charger-panel",class extends E{get panelType(){return"ev_charger"}get defaultPanelTitle(){return"EV CHARGER"}get frameColor(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=e.get("charging_power")?.state?.state,r=null!=a?parseFloat(a):null;return(0,l.N)(t,r)}static get styles(){return[...super.styles,i.AM,J]}_entityMap(){if(this.__entityMapCache)return this.__entityMapCache;const e=new Map;for(const t of this._getAllEntities()){const a=ee(t);a&&!e.has(a)&&e.set(a,t)}return this.__entityMapCache=e,e}updated(e){super.updated(e),this.__entityMapCache=null}renderBadge(){const e=this._entityMap(),t=e.get("status")?.state?.state,a=(0,l.WG)(t),s=this.frameColor;return r.qy`<lcars-summary-badge value="${a}" color="${s}"></lcars-summary-badge>`}renderContent(){const e=this._entityMap(),t=e.get("status")?.state?.state;if(!t||"unavailable"===t||"unknown"===t)return r.qy`
    ...
    `}_renderTempGrid(e){const t=new Map;for(const a of e){const e=a.area?.name||"Unknown";t.has(e)||t.set(e,{temp:null,humidity:null});const r=a.state?.attributes?.device_class,s=Number(a.state?.state);if("temperature"===r&&!isNaN(s)){const r=t.get(e);(!r.temp||s>0)&&(r.temp={entry:a,val:s})}"humidity"!==r||isNaN(s)||(t.get(e).humidity={entry:a,val:s})}const a=[...t.entries()].filter(([,e])=>e.temp||e.humidity).sort((e,t)=>e[0].localeCompare(t[0]));return 0===a.length?"":r.qy`
      <div class="ls-section">
        <div class="ls-section-header">
        ...
        <div class="ls-purifier-table">
          ...
          ${a.map(([e,t])=>{const a=t.temp?t.temp.val<68?"var(--lcars-bluey)":t.temp.val<=76?"var(--lcars-ice)":"var(--lcars-butterscotch)":"var(--lcars-gray)",i=t.temp?t.temp.val>=65&&t.temp.val<=78?"NORMAL":t.temp.val<65?"COOL":"WARM":"—",n="NORMAL"===i?"var(--lcars-ice)":"COOL"===i?"var(--lcars-bluey)":"var(--lcars-butterscotch)";return r.qy`
      ...
      <div class="ls-section">
        ...
        ${n.length>0?r.qy`
          ...
          <div class="ls-purifier-table">
            ...
            ${n.map(e=>{const t=null!=e.metrics.score?e.metrics.score>=80?"var(--lcars-ice)":e.metrics.score>=60?"var(--lcars-sunflower)":"var(--lcars-tomato)":"var(--lcars-gray)",a=null!=e.metrics.pm25?e.metrics.pm25<=12?"var(--lcars-ice)":e.metrics.pm25<=35?"var(--lcars-sunflower)":"var(--lcars-tomato)":"var(--lcars-gray)",s=null!=e.metrics.co2?e.metrics.co2<=600?"var(--lcars-ice)":e.metrics.co2<=1e3?"var(--lcars-sunflower)":"var(--lcars-tomato)":"var(--lcars-gray)",i=null!=e.metrics.voc?e.metrics.voc<=150?"var(--lcars-ice)":e.metrics.voc<=500?"var(--lcars-sunflower)":"var(--lcars-tomato)":"var(--lcars-gray)",n=null!=e.metrics.temp?e.metrics.temp<68?"var(--lcars-bluey)":e.metrics.temp<=76?"var(--lcars-ice)":"var(--lcars-butterscotch)":"var(--lcars-gray)";return r.qy`

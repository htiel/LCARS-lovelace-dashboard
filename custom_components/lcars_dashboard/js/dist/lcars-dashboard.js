      ...
      <div class="eng-section">
        ...
        <div class="eng-loads-split">
          ...
          <div class="eng-loads-bars">
            ...
            ${t.slice(0,24).map(e=>{const t=Math.min(100,e.watts/a*100);return r.qy`

    ...
    `}}Promise.race([customElements.whenDefined("hui-masonry-view"),new Promise(e=>setTimeout(e,5e3))]).then(()=>{if(!customElements.get("lcars-dashboard-layout")){customElements.define("lcars-dashboard-layout",i);const e=a(330);r.g0.info(s,`v${e.version} registered`),console.info(`%c LCARS-DASHBOARD \n%c Version ${e.version}`,"color: #ff9966; font-weight: bold; background: black","color: #f5f6fa; font-weight: bold; background: #333")}})})(),(()=>{var e=a(845),t=a(622),r=a(851);const s="Homepage",i=new Set(["light","switch","fan","input_boolean","lock","automation","script"]),n=new Set(["sensor","binary_sensor"]),o=new Set(["camera"]),l=new Set(["climate"]),c=new Set(["cover"]),d=new Set(["media_player"]),p={light:"Lights",switch:"Switches",fan:"Fans",lock:"Locks",input_boolean:"Toggles",automation:"Automations",script:"Scripts",sensor:"Sensors",binary_sensor:"Binary Sensors",camera:"Cameras",climate:"Climate",cover:"Covers",media_player:"Media",button:"Buttons",number:"Numbers",select:"Selects",input_number:"Inputs",input_select:"Selectors",input_text:"Text Inputs",input_button:"Buttons",input_datetime:"Date/Time",scene:"Scenes",device_tracker:"Trackers",person:"People",update:"Updates",event:"Events",conversation:"Conversation"},h={camera:0,light:1,switch:2,climate:3,cover:4,media_player:5,fan:6,lock:7,sensor:8,binary_sensor:9};class u extends e.WF{static get properties(){return{data:{type:Object},selectedArea:{type:String},_hass:{type:Object},_cards:{type:Object}}}constructor(){super(),this.data=null,this.selectedArea=null,this._cards={},this._cachedEntities=null,this._cachedAreaId=null,this._onAreaSelected=e=>{r.g0.debug(s,"Area selected event:",e.detail.areaId),this.selectedArea=e.detail.areaId,this._cachedEntities=null}}connectedCallback(){super.connectedCallback(),r.o6.addEventListener("lcars-area-selected",this._onAreaSelected)}disconnectedCallback(){super.disconnectedCallback(),r.o6.removeEventListener("lcars-area-selected",this._onAreaSelected)}setConfig(e){this._config=e}set hass(e){const t=this._hass;this._hass=e,!t||t.entities===e.entities&&t.devices===e.devices||(this._cachedEntities=null),t&&t.areas!==e.areas&&this.selectedArea&&(e.areas?.[this.selectedArea]||(this.selectedArea=null,this._cachedEntities=null)),this._cards&&Object.values(this._cards).forEach(t=>{t&&void 0!==t.hass&&(t.hass=e)}),this.data||this._loadConfiguration()}async _loadConfiguration(){if(this._hass){r.g0.debug(s,"Loading configuration via WS...");try{const e=await this._hass.callWS({type:"lcars_dashboard/configuration/get"});this.data=e,r.g0.debug(s,"Configuration loaded:",Object.keys(e))}catch(e){r.g0.error(s,"Failed to load configuration",e),this.data={}}}}_handleEntityClick(e){(0,r.Hv)(e)}_handleToggle(e){const t=e.split(".")[0];if("lock"===t){const t=this._getEntityState(e);this._hass.callService("lock","locked"===t?.state?"unlock":"lock",{entity_id:e})}else"script"===t?this._hass.callService("script","turn_on",{entity_id:e}):this._hass.callService("homeassistant","toggle",{entity_id:e})}_getAreaEntities(e){if(!this._hass)return[];if(this._cachedEntities&&this._cachedAreaId===e)return r.g0.debug(s,"Entity cache HIT for area:",e,this._cachedEntities.length,"entities"),this._cachedEntities;r.g0.debug(s,"Entity cache MISS — resolving area:",e);const t=Object.values(this._hass.entities||{}),a=this._hass.devices||{},i=new Set;Object.values(a).forEach(t=>{t.area_id===e&&i.add(t.id)});const n=t.filter(t=>!(t.hidden_by||t.disabled_by||t.entity_category||t.area_id!==e&&(t.area_id||!t.device_id||!i.has(t.device_id))));return this._cachedEntities=n,this._cachedAreaId=e,r.g0.debug(s,"Resolved",n.length,"entities for area:",e),n}_groupEntities(e){const t=this._hass.devices||{},a=new Map,r=[];e.forEach(e=>{const s=e.entity_id.split(".")[0],i={entity:e,domain:s,state:this._getEntityState(e.entity_id)};i.state&&(e.device_id&&t[e.device_id]?(a.has(e.device_id)||a.set(e.device_id,{device:t[e.device_id],entities:[]}),a.get(e.device_id).entities.push(i)):r.push(i))});const s=(e,t)=>{const a=h[e.domain]??50,r=h[t.domain]??50;return a!==r?a-r:(e.state?.attributes?.friendly_name||"").localeCompare(t.state?.attributes?.friendly_name||"")};return a.forEach(e=>e.entities.sort(s)),r.sort(s),{byDevice:a,noDevice:r}}_groupByDomain(e){const t=new Map;return e.forEach(e=>{t.has(e.domain)||t.set(e.domain,[]),t.get(e.domain).push(e)}),[...t.entries()].sort((e,t)=>(h[e[0]]??50)-(h[t[0]]??50))}_getEntityState(e){return this._hass&&this._hass.states[e]?this._hass.states[e]:null}_getEntityIcon(e){return e?e.attributes?.icon?e.attributes.icon:{light:"mdi:lightbulb",switch:"mdi:toggle-switch",sensor:"mdi:eye",binary_sensor:"mdi:radiobox-blank",climate:"mdi:thermostat",cover:"mdi:window-shutter",fan:"mdi:fan",lock:"mdi:lock",camera:"mdi:video",media_player:"mdi:cast",automation:"mdi:robot",script:"mdi:script-text",update:"mdi:package-up"}[e.entity_id.split(".")[0]]||"mdi:information-outline":"mdi:help-circle-outline"}_friendlyName(e,t){return e?.attributes?.friendly_name||t.entity_id.split(".").pop().replace(/_/g," ")}_isOff(e){return["off","unavailable","unknown","idle","standby","locked"].includes(e?.state)}_renderSensorBar(t){const a=parseFloat(t.state);if(isNaN(a))return"";const r=t.attributes?.device_class||"";let s=0,i=100;if("temperature"===r)s=10,i=40;else if("humidity"===r)s=0,i=100;else if("battery"===r)s=0,i=100;else if("illuminance"===r)s=0,i=1e3;else if("power"===r)s=0,i=3e3;else{if(null==t.attributes?.min)return"";s=t.attributes.min,i=t.attributes.max}const n=Math.max(0,Math.min(100,(a-s)/(i-s)*100)),o=Math.round(n/100*10);return e.qy`
      ...
      `)}`}_renderDomainEntities(e,t){return o.has(e)?this._renderCameras(t):i.has(e)?this._renderToggles(t):l.has(e)?this._renderClimates(t):c.has(e)?this._renderCovers(t):d.has(e)?this._renderMedia(t):n.has(e)?this._renderSensors(t):this._renderGeneric(t)}_renderCameras(t){return e.qy`<div class="camera-grid">
        ...
        ${t.map(({entity:t,state:a},r)=>{const s=this._friendlyName(a,t),i=this._isOff(a);return e.qy`
          ...
          `})}
      </div>`}getCardSize(){return 6}}customElements.get("homepage-card")||customElements.define("homepage-card",u)})(),(()=>{var e=a(845),t=a(622),r=a(851);class s extends e.WF{static get properties(){return{_hass:{type:Object},_config:{type:Object},_pages:{type:Array}}}constructor(){super(),this._pages=[]}set hass(e){this._hass=e,0===this._pages.length&&this._loadPages()}setConfig(e){this._config=e}async _loadPages(){if(this._hass)try{const e=await this._hass.callWS({type:"lcars_dashboard/configuration/get"});e&&e.more_pages&&(this._pages=Object.entries(e.more_pages).map(([e,t])=>({id:e,...t})))}catch(e){console.warn("LCARS: Could not load more-pages",e)}}_openPage(e){(0,r.oo)(`/lcars-dashboard/more/${e}`)}static get styles(){return[t.B,e.AH`
          :host { display: block; }

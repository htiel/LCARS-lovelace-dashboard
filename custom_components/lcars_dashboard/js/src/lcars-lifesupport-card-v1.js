 ...
 * Superseded by lcars-lifesupport-card.js (which registers the same
 * `lifesupport-card` custom element). This v1 file is NOT in webpack entries
  ...
  static get styles() {
    return [
      ...
      css`
        ...
        .ls-devices { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(16rem, 100%), 1fr)); gap: 0.375rem; }

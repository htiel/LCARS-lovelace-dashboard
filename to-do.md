Level 1 changes for 4.x.x
    ...
    **REFERENCE: [purifier-card](https://github.com/denysdovhan/purifier-card) (v2.8.0, MIT, LitElement/TS)**
    ...
    2. arange the area dashboard by floor in the navbar using the area configuraion, so each floor gets it sections and the areas are below the floor, if I click on the floor it should combine all the devices in that floor in a singel view, and then I can drill down by selecting the actual room/area.

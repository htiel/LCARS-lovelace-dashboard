# LCARS Dashboard — Backlog Index

Backlogs have been split into focused files:

- **[plans/backlog-4x.md](plans/backlog-4x.md)** — 4.x stable branch (non-breaking features, bug fixes)
- **[plans/backlog-5x.md](plans/backlog-5x.md)** — 5.x beta branch (multi-dashboard, breaking changes)
